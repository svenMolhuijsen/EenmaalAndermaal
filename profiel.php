...
$verlopenveilingen = executeQuery("SELECT titel, beschrijving, verkoopPrijs, verkoperGebruikersnaam from veiling where verkoperGebruikersnaam = ? and veilingGestopt = ?",[$gebruikersnaam,1 ]);
            ...
            <div class="row">
                ...
                if($aantalVerlopenVeilingen > 0){
                    for($i =0; $i<$aantalVerlopenVeilingen; $i++){
                        echo('<div><span><strong>Titel:</strong> ' . $verlopenveilingen['data'][$i]["titel"] . '</span><br><span><strong>Omschrijving:</strong> ' . $verlopenveilingen['data'][$i]["beschrijving"] . '</span><br><span><strong>Prijs:</strong> ' . $verlopenveilingen['data'][$i]["verkoopPrijs"] . '</span><br><span><strong>Verkocht Aan:</strong> ' . $verlopenveilingen['data'][$i]["verkoperGebruikersnaam"] . '</span></div>');
                        echo '<hr>';
                    }
                } else{
