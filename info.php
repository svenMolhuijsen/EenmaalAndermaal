            ...
            <div class="row">
                <h4>Frequently Asked Questions: </h4>
                    <div class = "row columns">
                        ...
                        <h6>Hoe werkt een veiling?</h6>
                        <p style="color: #f2552c"> Een veiling op EenmaalAndermaal wordt altijd gestart door een verkoper. Wanneer een veiling is geopend kunnen gebruikers daarop bieden. Diegene die het hoogste bod heeft als de veiling is geëindigd is de winnaar. Deze winnaar krijgt een mailtje toegestuurd met daarin gegevens van de verkoper. Nadat de mail is verzonden is het aan de verkoper en winnaar om afspraken te maken over de transactie en overhandiging. Hier speelt EenmaalAndermaal geen rol in.        </p>
                        <h6>Kan ik zelf een veiling starten?</h6>
                        <p style="color: #f2552c">Als verkoper kan je zelf een veiling aanmaken. Op de homepage is een knop die leidt naar de pagina. Hier kan je alle gegevens die nodig zijn voor een veiling invullen. En jouw veiling naar wens aanpassen. </p>
                        <h6 >Hoe weet ik wanneer ik een veiling heb gewonnen?</h6>
                        <p  style="color: #f2552c"> Wanneer u het winnende bod heeft op een veiling krijgt u een mailtje 	binnen als bevestiging. In dit mailtje zijn ook de contactgegevens van de 	verkoper weergeven.</p>
                        <h6 >Moet ik mijn veiling verwijderen als die verlopen is?</h6>
                        <p style="color: #f2552c">Het is niet nodig om uw veiling te verwijderen als de einddatum is overschreden. Uw veiling blijft altijd bestaan, echter kan er uiteraard niet meer geboden worden op uw veiling als die al gesloten is. </p>
                        <h6 >Kan ik, als verkoper, de eindtijd van mijn veiling bepalen?</h6>
                        <p style="color: #f2552c">Ja, het is mogelijk om een eindtijd te bepalen van een veiling. Houd er 	rekening mee dat mensen sneller bieden als de einddatum dichtbij is. </p>
                        <h6 >Kan ik zien hoe vaak mijn veiling bekeken wordt?</h6>
                        <p style="color: #f2552c"> Ja, je kan zien hoe vaak je veiling is bekeken. Op je ‘Profiel’ pagina heb je 	de mogelijkheid om je eigen veilingen te bekijken. </p>
                    </div>
                    </div>
                    <div class = "row columns">
                        ...
                        <p >Hoe kan ik mijn persoonsgegevens wijzigen?</p>
                        <p  style="color: #f2552c">Op de <a href = "profiel.php" style="color: #0a0a0a;" >Profiel</a> pagina kunt u uw gegevens inzien en wijzigen. </p>
                        <p >Hoe gaat EenmaalAndermaal om met mijn persoongegevens?</p>
                        <p  style="color: #f2552c">EenmaalAndermaal gaat zeer vertrouwelijk om met uw gegevens. 		Slechts een beperkte selectie van ons bedrijf heeft toegang tot uw 		gegevens. Voor meer informatie kunt u onze terms of service lezen of 	mail naar  info@EenmaalAndermaal.nl </p>
                    </div>
                    </div>
                    <div class = "row columns">
                        ...
                        <h6 >Kan ik mijn bod annuleren als de veiling nog loopt?</h6>
                        <p style="color: #f2552c">Als je een bod hebt geplaatst terwijl je het daar toch niet eens mee bent is het helaas niet mogelijk om je bod terug te trekken. Echter zit je nergens aan vast. Je bent niet verplicht om te betalen als je het winnende bod hebt. De transactie gaat in overleg met de verkoper, daar kun je aangeven dat je van gedachten veranderd bent. Denk eraan dat het niet op prijs wordt gesteld.   </p>
                        <h6 >Is er een mogelijkheid om een winnend bod af te wijzen omdat ik de prijs te laag vindt?</h6>
                        <p  style="color: #f2552c">Er is geen mogelijkheid om op EenmaalAndermaal een bod af te wijzen. 	Echter kan je wel in overleg met de bieder het bod afwijzen. Als je je		product niet onder een bepaalde prijs wilt verkopen kan je een startprijs 	meegeven. Voor de bieders is het dan niet mogelijk om onder de 		startprijs te bieden. </p>
                        <h6 >Kan ik mijn lopende biedingen zien?	</h6>
                        <p  style="color: #f2552c"> Je kan je lopende biedingen inzien op je <a href = profiel.php" style="color: #0a0a0a;" >Profiel</a> pagina.	</p>
                    </div>
                    </div>
                    <div class = "row columns">
                        ...
                        <h6 >Speelt EenmaalAndermaal ook een rol bij de transactie en verzending 	van het product? </h6>
                        <p  style="color: #f2552c">Nee, EenmaalAndermaal speelt geen rol bij de transactie of 			verzending van het product. Het is de bedoeling dat koper en 			verkoper zelf contact zoeken. Echter levert EenmaalAndermaal wel 		de contactgegevens. </p>
                    </div>
                    </div>
            </div>
        </div>
                ...
                <div class="row">
                    <h4 class="columns">Contact: </h4>
                        <p class="columns">Heeft u een vraag, opmerking of suggestie? U kunt ten alle tijden mailen naar:
                            <a href =# style="color:#f2552c;"> info@EenmaalAndermaal.nl</a>
                            <br>
    ...
    <div class="tabs-panel" id="TermsOfService">
        <div class="row">
            <h4 class="columns" style="color: #f2552c">Terms of Service: </h4>
                ...
                <h6><b>Gebruik van EenmaalAndermaal </b></h6>
                <p style="margin-bottom: 0px;">Wanneer je gebruikmaakt van EenmaalAndermaal, is het volgende <b>niet toegestaan</b>: </p>
                <ul style="margin-top: 6px;"><li><p>inhoud of objecten in verkeerde rubrieken of gedeeltes van onze sites en services plaatsen; </p></li><li><p>de wetten, rechten van derden, of ons beleid, zoals het beleid voor Verboden en beperkte objecten schenden; </p></li><li><p>gebruikmaken van onze sites en services als je geen wettelijk bindende contracten mag aangaan, jonger bent dan 18, of tijdelijk of voor onbepaalde duur bent geschorst wegens misbruik van onze sites; </p></li><li><p>niet betalen voor objecten die je hebt gekocht, tenzij de verkoper wezenlijke wijzigingen heeft aangebracht in de objectbeschrijving nadat je hebt geboden, er een duidelijke typfout is gemaakt, of je de identiteit van de verkoper niet kunt verifiëren; </p></li><li><p>objecten die bij je zijn gekocht niet leveren, tenzij de koper zich niet houdt aan de vastgelegde voorwaarden, of je de identiteit van de koper niet kunt verifiëren; </p></li><li><p>de prijs van een object manipuleren of aanbiedingen van andere gebruikers belemmeren; </p></li><li><p>onze kostenstructuur, het factureringsproces of kosten verschuldigd aan EenmaalAndermaal omzeilen of manipuleren; </p></li><li><p>valse, onnauwkeurige, misleidende, lasterlijke of smadelijke inhoud op EenmaalAndermaal plaatsen of persoonlijke gegevens op EenmaalAndermaal zetten; </p></li><li  "><p>handelingen uitvoeren die het feedback- of het beoordelingssysteem ondermijnen (zoals het weergeven, importeren of exporteren van feedbackgegevens buiten de sites of deze gebruiken voor doeleinden die niets te maken hebben met EenmaalAndermaal); </p></li><li  "><p>je EenmaalAndermaal-account (inclusief feedback) en gebruikersnaam zonder onze toestemming overdragen aan een andere partij; geen veiligheidsmaatregelen treffen om je wachtwoord te beschermen; gebruikmaken van EenmaalAndermaal met de gebruikersnaam of het wachtwoord van iemand anders, of iemand anders toestaan (rechtstreeks of onrechtstreeks) je gebruikersnaam of wachtwoord te gebruiken; </p></li><li  "><p>spam, kettingbrieven of piramidespelen versturen of op EenmaalAndermaal plaatsen; </p></li><li><p>virussen of andere technologieën verspreiden die schade kunnen toebrengen aan EenmaalAndermaal of aan de belangen of eigendom van EenmaalAndermaal-gebruikers; </p></li><li><p>inhoud van de sites en auteursrechten en handelsmerken van EenmaalAndermaal kopiëren, wijzigen of verspreiden; </p></li><li><p>informatie over gebruikers verkrijgen of verzamelen, inclusief e-mailadressen, zonder hun toestemming. </p></li></ul>
                <h6><b>Privacy</b></h6>
        ...
        <div class="row">
            <h4 class="columns">About</h4>
            <p>
               <strong> About EenmaalAndermaal</strong>
                <br>
                EenmaalAndermaal is een veilingsite waarop gebruikers hun voorwerpen ter verkoop aanbieden en anderen bij opbod die voorwerpen kunnen kopen. Het is opgericht door I-Concepts en ontwikkeld door eerstejaars HAN ICA studenten.
            </p>
            <p>
                <strong>About I-Concepts</strong>
                <br>
                EenmaalAndermaal is een website van het bedrijf I-Concepts. I-Concepts is een nieuwe onderneming opgericht door Anton Mijnder. Anton Mijnder is de directeur van I-Concepts. I-Concepts is een bedrijf dat betrouwbaarheid hoog in het vaandel heeft staan. En wil graag concurreren met andere grote veilingsite’s.
            </p>
